...
void mesh_mpm_auth_peer(struct wpa_supplicant *wpa_s, const uint8_t *addr);
...
int mesh_mpm_close_peer(struct wpa_supplicant *wpa_s, const uint8_t *addr);
int mesh_mpm_connect_peer(struct wpa_supplicant *wpa_s, const uint8_t *addr,
			  int duration);
