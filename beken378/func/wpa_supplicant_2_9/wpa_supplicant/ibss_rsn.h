...
int ibss_rsn_start(struct ibss_rsn *ibss_rsn, const uint8_t *addr);
void ibss_rsn_stop(struct ibss_rsn *ibss_rsn, const uint8_t *peermac);
int ibss_rsn_rx_eapol(struct ibss_rsn *ibss_rsn, const uint8_t *src_addr,
		      const uint8_t *buf, size_t len);
void ibss_rsn_set_psk(struct ibss_rsn *ibss_rsn, const uint8_t *psk);
void ibss_rsn_handle_auth(struct ibss_rsn *ibss_rsn, const uint8_t *auth_frame,
			  size_t len);
