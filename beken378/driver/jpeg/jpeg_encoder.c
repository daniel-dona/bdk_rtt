...
#define JPEG_BITRATE_MIN_SIZE_640_480           (15 * 1024)
...
const UINT32 jpeg_quant_table[JPEG_QUANT_TAB_LEN] = 
{
    ...
    0x38290E10, 0x39351818, 0x3E565738, 0x4D334D62,
    0x57244016, 0x6B456912, 0x5C776137, 0x4E507351,
    0x65595231, 0x79686843, 0x78796D5C, 0x63666248,
    
    // Chrominance quantization table (standard quality ~50)  
    0x2F181812, 0x63636315, 0x6363631A, 0x6363632F,
...
const UINT32 jpeg_quant_table[JPEG_QUANT_TAB_LEN] = 
{
    ...
    0x12181410, 0x1D1B1214, 0x1E261F18, 0x1E1D1D1A,
    0x24201C1C, 0x2C23271C, 0x2C293728, 0x34313030,
    0x2734271F, 0x383D323C, 0x2E333234, 0x32323232,
    
    // High quality chrominance table
    0x18090909, 0x21180D0B, 0x32321821, 0x3232211C,
    0x32323232, 0x32323232, 0x32323232, 0x32323232,
    0x32323232, 0x32323232, 0x32323232, 0x32323232,
    0x32323232, 0x32323232, 0x32323232, 0x32323232
};
...
void ejpeg_set_target_bitrate_size(UINT32 ppi_type)
{
    ...
    case VGA_640_480:
        ...
        break;
    case VGA_1280_720:
        ejpeg_set_target_high_byte(JPEG_BITRATE_MAX_SIZE_1280_720);
        ejpeg_set_target_low_byte(JPEG_BITRATE_MIN_SIZE_1280_720);
        os_printf("set 1280x720 bitrate size\r\n");
        break;

    default:
        ejpeg_set_target_high_byte(JPEG_BITRATE_MAX_SIZE_640_480);
        ejpeg_set_target_low_byte(JPEG_BITRATE_MIN_SIZE_640_480);
        os_printf("bitrate unknown, use QVGA\r\n");
        break;
    }
}
...
static void ejpeg_hardware_init(void)
{
    ...
    #if (CFG_SOC_NAME == SOC_BK7236)
    /* register interrupt */
    intc_service_register(IRQ_JPEG_ENCODER, PRI_JPEG_ENCODER, ejpeg_isr);
    #else
    /* register interrupt */
