...
#if (CFG_USE_PTA)
	*(volatile unsigned int *)(0x800008) |= 0x01000000;
#else
	*(volatile unsigned int *)(0x800008) &= 0xFEFFFFFF;
#endif

	//ble debug pin
#if 0
	*(volatile unsigned int *)(0x802800 + 0x2A * 4) = 5;
	*(volatile unsigned int *)(0x802800 + 0x2B * 4) |= 0xFF00;
	*(volatile unsigned int *)(0x800008 + 0x0D * 4) &= 0x00FFFFFF;

	*(volatile unsigned int *)(0x802800 + 0x1A * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x18 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x17 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x16 * 4) = 0x40;
#endif

#if 0
	*(volatile unsigned int *)(0x802800 + 0x2A * 4) = 5;
	*(volatile unsigned int *)(0x802800 + 0x2B * 4) |= 0xFF00;
	*(volatile unsigned int *)(0x800000 + 0x0D * 4) &= 0x00FFFFFF;
	*(volatile unsigned int *)(0x800000 + 0x0D * 4) |= 0x04000000;

	*(volatile unsigned int *)(0x802800 + 0x1A * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x18 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x17 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x16 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x15 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x14 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x11 * 4) = 0x40;
	*(volatile unsigned int *)(0x802800 + 0x10 * 4) = 0x40;
#endif
